...
//        crossAxisAlignment: CrossAxisAlignment.center,
        children: <Widget>[new FindpwdBody()],
      ),
    );
  }
}

class FindpwdBody extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    void sendCode() {
      ...
      bool _ok = false;
      //验证注册
      if (!_phone.hasMatch(_controllerTel.text.toString())) {
        _showText = "手机号格式不正确";
    ...
    void findPwd() {
      ...
      findPwdService(_controllerPwd.toString(), _controllerTel.toString(),
              _controllerVerif.toString())
          .then((onValue) {
